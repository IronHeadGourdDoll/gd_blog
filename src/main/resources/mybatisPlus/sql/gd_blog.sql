...
CREATE TABLE `blog_visit_log`  (
  `id` int(11) NOT NULL,
  `blog_id` int(11) NULL DEFAULT NULL COMMENT '访问博客的id',
...
CREATE TABLE `bolgger_visit_log`  (
  `id` int(11) NOT NULL,
  `visited_name` varchar(45) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '被访问的用户名',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '博主浏览记录表（我看过谁（博客留言板等都会被记录））=》求和-网站浏览记录表' ROW_FORMAT = Dynamic;
...
-- ----------------------------
-- Table structure for log_spu
-- ----------------------------
DROP TABLE IF EXISTS `log_spu`;
CREATE TABLE `log_spu`  (
  `id` int(11) NOT NULL,
  ...
  `result_json` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '访问博客会被记录到blog_visit_log，blogger_visit_log，login_log三个表\r\n访问留言板，关于我等会被记录到login_log，blog_visit_log\r\n操作会被记录到login_log，operate_log\r\n\r\n相同ip一段时间内（2小时）重复访问只会记录一次' ROW_FORMAT = Dynamic;
...
CREATE TABLE `login_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '登录日志表，用来度量网站访问量（访问留言板等都算）。同一ip一段时间访问无论是否登录都会插入一条记录，未登录status=0，登录为1' ROW_FORMAT = Dynamic;
...
CREATE TABLE `operate_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '操作日志，增删改都会记录' ROW_FORMAT = Dynamic;
...
-- Records of role
-- ----------------------------
INSERT INTO `role` VALUES (1, 1, 'ROLE_USER', '123');
INSERT INTO `role` VALUES (2, 1, 'ROLE_USER_no_recommend', '123');
INSERT INTO `role` VALUES (3, 1, 'ROLE_USER_no_message', '123');
INSERT INTO `role` VALUES (4, 1, 'ROLE_USER_no_dislike', '123');
INSERT INTO `role` VALUES (5, 1, 'ROLE_ADMIN', '123');
INSERT INTO `role` VALUES (6, 1, 'ROLE_SUPERADMIN', '123');
...
CREATE TABLE `user`  (
  ...
  `pageviews` int(11) NULL DEFAULT NULL COMMENT '一段时间内博客或留言板每被浏览一次退出时+1',
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1, 'wuliang', 'hypocrisy', '123456', '1', '2020-06-06 00:36:03.067486', '成都市双流区', '本科', '学生', '我是一个人', '快乐', '全能', 'AI', 'entertainment', '2020-06-06 00:36:03.067486', 0, 0, 32, 0, 0, 5, 3, 1, 0);
INSERT INTO `user` VALUES (2, 'test1', '测试', '123456', '0', '2020-06-06 00:35:57.002963', '成都市双流区', '硕士', 'Java开发工程', NULL, NULL, NULL, NULL, NULL, '2020-06-06 00:35:57.002963', 0, 23, 342, 0, 13, 0, 0, 0, 2);
INSERT INTO `user` VALUES (3, 'zhangsan', '张三', '123456', '1', '2020-06-06 00:36:05.550975', '成都市高新区', '博士', '深度学习算法工程师', '我是一个大佬', NULL, NULL, NULL, NULL, '2020-06-06 00:36:05.550975', 0, 0, 0, 0, 0, 0, 7, 32, 0);
...
INSERT INTO `user_role` VALUES (2, 'wuliang');
